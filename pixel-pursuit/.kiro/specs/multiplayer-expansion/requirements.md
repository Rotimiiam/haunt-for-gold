...
This feature will expand the multiplayer capabilities of Haunt For Gold to support more than two players with customizable game parameters. Players will be able to create custom lobbies, set game rules, and enjoy larger multiplayer battles with friends.

## Implementation Status: ⏳ FUTURE WORK

Current online multiplayer supports:
- ✅ 1v1 matchmaking with queue system
- ✅ Rematch functionality
- ✅ Real-time gameplay via Socket.IO

Future expansion will add:
- Custom lobbies with 2-8 players
